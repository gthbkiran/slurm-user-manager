...
public class SlurmController {
    ...
    public ModelAndView updateAccount() {
        ...
        modelAndView.addObject("body", "update"); // Reuse the same fragment for simplicity
        return modelAndView;
    }
    ...
    public ModelAndView deleteAccount() {
        ...
        modelAndView.addObject("body", "delete"); // Reuse the same fragment for simplicity
        return modelAndView;
    }
    ...
    public ModelAndView executeAddScript(@RequestParam("username") String param1,
    ...
    @PostMapping("/runshellscript/update")
    public ModelAndView executeUpdateScript(@RequestParam("username") String param1,
                                      @RequestParam("password") String param2, Model model) throws IOException, InterruptedException {
    ...
    @PostMapping("/runshellscript/delete")
    public ModelAndView executeDeleteScript(@RequestParam("username") String param1, Model model) throws IOException, InterruptedException {
    ...
    public ModelAndView executeUserCountScript() throws IOException, InterruptedException {
		 /*try {
			 // Path to your shell script
            String scriptPath = "C:/Users/91911/study/Shell_Script/first.sh";
            String currentPath = System.getProperty("user.dir");
        ...
        try {
            ...
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(process.getInputStream()))) {
                String line;
                boolean isUserSection = false; // Flag to identify the list of usernames
                while ((line = reader.readLine()) != null) {
                    outputlogs.append(line).append("\n");
            ...
            int exitCode = process.waitFor();
            modelAndView.setViewName("layout");
            modelAndView.addObject("body", "countresult");
           // modelAndView.addObject("param1",param1);
           // modelAndView.addObject("param2",param2);
        ...
        modelAndView.addObject("outputLogs", outputlogs.toString()+"Kirankkumar");
